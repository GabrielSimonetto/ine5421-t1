...
class CfgProcessor:
    ...
    def __theorem_first_clause(self, prod1: Production,
        ...
        if not valid:
            print(f'Prod1 first:: {prod1_first} ')
            print(f'Prod2 first:: {prod2_first} ')
    ...
    def __theorem_second_clause(self, prod1: Production,
        ...
        if prod1.head != prod2.head:
            print(f'Theorem do not apply to different heads: {prod1}, {prod2}')
            exit(1)
        ...
        if not valid:
            ...
            print(f'Prod1 first: {prod1_body_first}')
            print(f'Prod2 first: {prod2_body_first}')
            print(f'Head follow: {head_follow}')
    ...
    def __apply_theorem_all_prods_of(self, nt: str) -> bool:
        ...
        for p1, p2 in combinations(prods, 2):
            ...
            if not (first_clause and second_clause):
                print(f'Grammar is not LL(1) due to: {p1}, {p2}')
                return False
